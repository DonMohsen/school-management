...
const renderRow=(item:TeacherListType)=>(
  ...
  className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLight"
   key={item.id}>
    ...
    <Image src={item.img||"/noAvatar.png"} alt="photo" width={40} height={40} className="md:hidden xl:block w-10 h-10 rounded-full object-cover"/>
    ...
    <td>
      <div className="flex items-center gap-2 ">
        ...
        <button className=" hover:brightness-75 flex items-center justify-center w-7 h-7 rounded-full bg-lamaSky">
